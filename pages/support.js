  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Support The AI NEWS with donations via PayPal, Buy Me a Coffee, or Patreon. Help us continue providing quality AI journalism." />
        <meta property="og:title" content="Support Us – The AI NEWS" />
        <meta property="og:description" content="Support The AI NEWS with donations via PayPal, Buy Me a Coffee, or Patreon. Help us continue providing quality AI journalism." />
        ...
        <meta name="twitter:description" content="Support The AI NEWS with donations via PayPal, Buy Me a Coffee, or Patreon. Help us continue providing quality AI journalism." />
      ...
      <div className="content-container support-main">
        ...
        <div className="support-cards-row">
          <a className="support-card" href="https://www.paypal.me/zakariatanani99" target="_blank" rel="noopener noreferrer">
            <img src="/paypal-icon.png" alt="PayPal" className="support-card-icon" />
            <span className="support-card-label">PayPal</span>
          </a>
          <a className="support-card" href="https://coff.ee/theainews" target="_blank" rel="noopener noreferrer">
          ...
          <a className="support-card" href="https://patreon.com" target="_blank" rel="noopener noreferrer">
            <img src="/patreon-icon.png" alt="Patreon" className="support-card-icon" />
            <span className="support-card-label">Patreon</span>
          </a>
        </div>
